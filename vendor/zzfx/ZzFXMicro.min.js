...
zzfxV=.3,               // volume
zzfxX=0,                 // audio context (created lazily)
zzfx=                   // play sound
(p=1,k=.05,b=220,e=0,r=0,t=.1,q=0,D=1,u=0,y=0,v=0,z=0,l=0,E=0,A=0,F=0,c=0,w=1,m=0,B=0
,N=0)=>{let Audio=globalThis.AudioContext||globalThis.webkitAudioContext;if(!zzfxX){if(!Audio)throw Error('Web Audio unavailable');zzfxX=new Audio}let M=Math,d=2*M.PI,R=44100,G=u*=500*d/R/R,C=b*=(1-k+2*k*M.random(k=[]))*d/R,
