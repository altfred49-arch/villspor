...
<div class="debug-actions"><button id="debugSound">Test lyder</button><button id="debugRoamer">Plasser vesen</button><button id="debugScent">Aktiver sporsans</button><button id="debugHeal">Helbred flokken</button><button id="debugBerry">+1 villbær</button><button id="debugReset">Nullstill tuning</button></div>
