...
const CREATURES={
  gnistrev:{id:'gnistrev',name:'Gnistrev',type:'ILD',bio:'En sky revegnist som lager små bål når den nyser.',base:{hp:42,attack:14,defense:9,speed:14},moves:['glosprang','askesnurr'],colors:['#f27b45','#ffd568','#6b3430'],shape:'fox'},
  mosemurr:{id:'mosemurr',name:'Mosemurr',type:'VEKST',bio:'En lun skogsånd som sover under mosekledde steiner.',base:{hp:48,attack:11,defense:14,speed:8},moves:['rotgrep','sporevind'],colors:['#6da85c','#b7d875','#355e45'],shape:'moss'},
  bekkskvett:{id:'bekkskvett',name:'Bekkskvett',type:'VANN',bio:'En rastløs bekkunge som alltid svømmer motstrøms.',base:{hp:44,attack:13,defense:10,speed:13},moves:['skumsprut','duggslor'],colors:['#55bdd3','#d7f4e9','#28617d'],shape:'otter'},
